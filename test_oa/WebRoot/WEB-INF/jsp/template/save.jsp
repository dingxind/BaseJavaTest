...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="template_%{id == null ? 'add' : 'edit'}" namespace="/" method="post" enctype="multipart/form-data">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                        <td>所用流程</td>
                        <td>
							<s:select cssClass="SelectStyle" name="processDefinitionKey" list="pdList" listKey="key" listValue="key"></s:select>
							*
						</td>
                    </tr>
                </table>
